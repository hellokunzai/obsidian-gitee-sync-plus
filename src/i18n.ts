...
const en = {
	...
	settingsGithubTokenDesc: "GitHub Settings → Developer settings → Personal access tokens; enable the repo permission.",
	tokenStoredInKeychain: "This token is automatically stored in your Obsidian keychain for security.",
	keychainMigrated: "Token moved to your Obsidian keychain for security.",
	keychainMigrateFailed: (msg: string) => `Keychain write failed: ${msg}`,
	...
	testToken: "Test",
	tokenSelectTitle: "Select token",
	tokenSearchPlaceholder: "Search keys...",
	tokenSelected: "Selected",
	tokenAdd: "Add key...",
	tokenSave: "Save",
	tokenCancel: "Cancel",
	tokenKeyId: "Key ID (lowercase letters, numbers, dashes)",
	tokenValue: "Token value",
	tokenConfirmAdd: "Add",
	tokenTestSuccess: "Token test succeeded.",
	tokenTestFailed: (message: string) => `Token test failed: ${message}`,
	tokenNoTokenSelected: "No token selected.",
	tokenDeleteConfirm: (name: string) => `Delete key "${name}" from the keychain?`,
	tokenDuplicateName: "A key with this ID already exists.",
	tokenNameRequired: "Please enter a key ID.",
	tokenValueRequired: "Please enter a token value.",
	tokenNoMatch: "No matching keys.",
	tokenEmpty: "No keys in the Obsidian keychain.",
	tokenSaveFailed: (message: string) => `Failed to save token: ${message}`,
	...
	panelStatusCommitCount: (committed: number, pending: number) => `${committed} / ${pending}`,
	...
	diffCollapseUnchanged: "Collapse unchanged fragments",
	diffIdenticalHint:
		"Local and remote contents are identical (only line endings or the sync state differ).",
	diffMarkSynced: "Mark as synced",
	diffShowAnyway: "Show diff anyway",
	diffMarkedAsSynced: (path: string) => `Marked "${path}" as synced`,
	diffMarkSyncedFailed: (msg: string) => `Could not mark as synced: ${msg}`,
	diffExpandUnchanged: "Expand unchanged fragments",
	diffUnchangedLines: (n: number) => `${n} unchanged lines`,
	diffLargeFileHint: (n: number) => `Large diff (${n} lines) — unchanged runs are collapsed; click a "⋯" row to expand.`,
	statusTagModified: "M",
	cancel: "Cancel",
	statusTagAdded: "U",
	statusTagDeleted: "D",
...
const zh: typeof en = {
	...
	settingsGithubTokenDesc: "GitHub 设置 → Developer settings → 访问令牌，需勾选 repo 权限。",
	tokenStoredInKeychain: "该令牌会自动存入你的 Obsidian 钥匙串（设置 → 钥匙串），数据文件中不再保留明文。",
	keychainMigrated: "令牌已迁移到 Obsidian 钥匙串。",
	keychainMigrateFailed: (msg: string) => `钥匙串写入失败：${msg}`,
	...
	selectToken: "选择秘钥",
	testToken: "测试",
	tokenSelectTitle: "选择密钥",
	tokenSearchPlaceholder: "查找密钥...",
	tokenSelected: "已选择",
	tokenAdd: "添加密钥...",
	tokenSave: "保存",
	tokenCancel: "取消",
	tokenKeyId: "密钥 ID（小写字母、数字、横线）",
	tokenValue: "令牌值",
	tokenConfirmAdd: "添加",
	tokenTestSuccess: "令牌测试成功。",
	tokenTestFailed: (message) => `令牌测试失败：${message}`,
	tokenNoTokenSelected: "未选择令牌。",
	tokenDeleteConfirm: (name) => `确定从钥匙串删除密钥 "${name}" 吗？`,
	tokenDuplicateName: "已存在相同 ID 的密钥。",
	tokenNameRequired: "请输入密钥 ID。",
	tokenValueRequired: "请输入令牌值。",
	tokenNoMatch: "没有匹配的密钥。",
	tokenEmpty: "Obsidian 钥匙串中暂无密钥。",
	tokenSaveFailed: (message) => `保存令牌失败：${message}`,
	...
	panelStatusCommitCount: (committed, pending) => `${committed} / ${pending}`,
	...
	diffCollapseUnchanged: "收起未更改的片段",
	diffIdenticalHint:
		"本地与远端内容完全一致（仅换行符或同步状态不同）。",
	diffMarkSynced: "标记为已同步",
	diffShowAnyway: "仍要显示差异",
	diffMarkedAsSynced: (path) => `已将“${path}”标记为已同步`,
	diffMarkSyncedFailed: (msg) => `无法标记为已同步：${msg}`,
	diffExpandUnchanged: "展开未更改的片段",
	diffUnchangedLines: (n: number) => `${n} 行未更改`,
	diffLargeFileHint: (n: number) => `差异较大（共 ${n} 行）——未更改的片段已折叠，点击「⋯」行可展开查看。`,
	statusTagModified: "M",
	cancel: "取消",
	statusTagAdded: "U",
	statusTagDeleted: "D",
